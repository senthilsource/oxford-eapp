...
jQuery(document).ready(function ($) {
    ...
    $.CoaStickyNote = function(element, options) {
        ...
        var defaults = {
            ...
            defaultTheme: { text: "Orange", value: "sticky-note-orange-theme" },
       ...
       /* plugin.init = function() {
            ...
            $element.dblclick(function (e) {
                ...
                defaults.notePosition = {top:e.clientY, left:e.clientX };
                plugin.settings = $.extend(true, {}, defaults, options);
         ...
         plugin.initialize = function(devoptions) {
            //plugin.settings = $.extend(true, {}, defaults, options);
          /*  $element.dblclick(function (e) {
                if (allSleeping()) {
                    return;
            ...
            plugin.settings = $.extend(true, {}, defaults, devoptions);
            createNoteBox($element);
        };
        ...
        plugin.loadExistingNote = function(existingNote, devoptions) {
        ...
        var createNoteBox = function($this, existingNote) {
            ...
            var noteBox = $("<div class='" + outerCssClass + " "
                ...
                var noteLeftPosition = note.settings.notePosition.left;
                console.log("display::",display);
                if(display=='double'){
                if(note.settings.notePosition.left>=800){
                  noteLeftPosition = noteLeftPosition-300;
                }
              }else{
                noteLeftPosition = noteLeftPosition/2;
                if(note.settings.notePosition.left>=400){
                  noteLeftPosition = noteLeftPosition-100;
                }
              }
            noteBox.css({
                zIndex: 9999,
