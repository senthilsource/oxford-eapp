(function ($) {
  ...
  $.fn.wPaint.menus.main = {
    ...
    items: {
      ...
      //   index: 1,
      //   callback: function () { this.setMode('Pen Highlighter'); }
      // },
      clear: {
        icon: 'generic',
        title: 'Clear',
      ...
      highlightSelection:{
        ...
        title: 'Pen Highlighter',
        index: 5,
        callback: function () { this.setMode('highlightSelection'); }
      },
      pencil: {
        icon: 'activate',
        title: 'Pencil',
  ...
  $.extend($.fn.wPaint.cursors, {
    ...
    pencil:    {path: 'ic_2.png', left: 0, top: 11.99},
    highlightSelection: {path: 'ic_3.png', left: 0, top: 10},
    ...
    eraser:  {path: 'cursor-eraser10.png', left: 6, top: 6}
  });
  ...
  $.fn.wPaint.extend({
    ...
    _drawHighlightSelectionMove: function (e) {
      var range, sel;
      var colour = "yellow";
      if (window.getSelection) {

        // $('.wPaint-canvas').hide();
        // $('#wpaint').attr("style", "display:none");
